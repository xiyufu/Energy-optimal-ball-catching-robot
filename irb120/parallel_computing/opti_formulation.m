...
% E = E + sum((T_remain - T)*(tau_holding./tau_max).^2);
%   % set objective function
opti.minimize(E); % set energy optimal
% opti.minimize(T); % or set time optimal
